...
python3 YOLO_preprocess.py --detr_p ../Deformable-DETR-Kaggle-Starfish-Detection/pre_proc --gbr_p ../Deformable-DETR-Kaggle-Starfish-Detection/pre_proc/tensorflow-great-barrier-reef